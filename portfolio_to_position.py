...
# portfolio.py
## This position file balamce the trade to the strength.
...
class Portfolio(object):
    ...
    def update_timeindex(self, event):
        ...
        if latest_datetime<self.start_date:
            return
        ...
        for s in self.symbol_list:
            if math.isnan(self.bars.get_latest_bar_value(s, "adj_close")):
                market_value = 0
                dh[s] = market_value
    ...
    def update_holdings_from_fill(self, fill):
        ...
        # print(self.bars.get_latest_bar_datetime(fill.symbol),cost,fill_cost,fill.symbol)
